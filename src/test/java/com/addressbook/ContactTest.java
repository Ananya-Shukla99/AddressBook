...
public class ContactTest {
	...
	public void givenValidContactDetails_whenObjectCreated_shouldReturnCorrectValues() {
		...
		Contact contact = new Contact("Tarus", "Prabhat", "New City", "Ariana", "Geornite", "567834", "7634237809",
				"tp@gmail.com");
	...
	public void givenTwoContactsWithSameName_whenCompared_shouldReturnEqual() {
		...
		Contact c1 = new Contact("AP", "Sharma", "Addr1", "City1", "State1", "111111", "9999999999", "a@mail.com");

		Contact c2 = new Contact("AP", "Sharma", "Addr2", "City2", "State2", "222222", "8888888888", "b@mail.com");
